    ...
    <main className="min-h-screen bg-slate-950 text-slate-100">
      ...
      <div className="border-b border-slate-800/60 bg-slate-950/80 backdrop-blur-sm sticky top-0 z-10">
        <div className="max-w-7xl mx-auto px-6 py-3 flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <span className="text-xs font-mono text-slate-400 tracking-wider">Scenario Sandbox</span>
          </div>
      ...
      <div className="max-w-7xl mx-auto px-6 py-10">
        ...
        <div className="mb-8">
          ...
          <h1 className="text-2xl font-light text-slate-100 mb-3">
            Scenario Sandbox
          </h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
          {[
            ...
            <div key={item.step} className="border border-slate-800 rounded-lg p-4 bg-slate-900/20">
              <p className="text-[10px] font-mono text-slate-700 mb-1">{item.step}</p>
              <p className="text-xs font-medium text-slate-300 mb-1.5">{item.title}</p>
        ...
        <div className="mt-12 pt-6 border-t border-slate-800/50 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            <Link href="/export" className="text-[10px] font-mono text-slate-600 hover:text-slate-400 transition-colors">
              Export →
            </Link>
            <Link href="/inspector" className="text-[10px] font-mono text-slate-600 hover:text-slate-400 transition-colors">
              Inspector →
            </Link>
          </div>
        </div>
